            ...
            <section className='w-[90vw] sm:w-[85vw] md:w-[80vw] flex flex-col sm:flex-row gap-3 justify-between items-center'>
                ...
                <div className="flex gap-3">
                  <div className="flex gap-2 items-center">
                    <Image className="h-[22px] w-[22px]" src={"/Cart.png"} alt="cart" width={400} height={400}></Image>
                    <p className="text-xs font-medium">Cart</p>
                  </div>
                    <Image className="h-[22px] w-[22px]" src={"/No.png"} alt="no" width={600} height={600}></Image>
