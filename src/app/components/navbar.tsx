        ...
        <section className='w-[90vw] sm:w-[85vw] md:w-[80vw] lg:w-[75vw] flex flex-col sm:flex-row gap-3 justify-between items-center'>  
          <div>
            <ul className="flex gap-5">
                ...
                <li><Link className="hover:text-[#007580]" href={"/"}>Shop</Link></li>       
                <li><Link className="hover:text-[#007580]" href={"/"}>Product</Link></li>          
                <li><Link className="hover:text-[#007580]" href={"/"}>Pages</Link></li>        
                <li><Link className="hover:text-[#007580]" href={"/"}>About</Link></li>        
            </ul>
          </div>
